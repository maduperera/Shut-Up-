...
public final class ClockFragment extends DeskClockFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle icicle) {
        ...
        final View fragmentView = inflater.inflate(com.wizardsofm.deskclock.R.layout.clock_fragment, container, false);

        mCityAdapter = new SelectedCitiesAdapter(getActivity());

        mCityList = (ListView) fragmentView.findViewById(com.wizardsofm.deskclock.R.id.cities);
        ...
        mClockFrame = fragmentView.findViewById(com.wizardsofm.deskclock.R.id.main_clock_left_pane);
        if (mClockFrame == null) {
            mClockFrame = inflater.inflate(com.wizardsofm.deskclock.R.layout.main_clock_frame, mCityList, false);
            mCityList.addHeaderView(mClockFrame, null, false);
            mHairline = mClockFrame.findViewById(com.wizardsofm.deskclock.R.id.hairline);
        } else {
            final View hairline = mClockFrame.findViewById(com.wizardsofm.deskclock.R.id.hairline);
            hairline.setVisibility(GONE);
        }

        mDigitalClock = (TextClock) mClockFrame.findViewById(com.wizardsofm.deskclock.R.id.digital_clock);
        mAnalogClock = mClockFrame.findViewById(com.wizardsofm.deskclock.R.id.analog_clock);
        return fragmentView;
    }
    ...
    public void onResume() {
        ...
        mDateFormat = getString(com.wizardsofm.deskclock.R.string.abbrev_wday_month_day_no_year);
        mDateFormatForAccessibility = getString(com.wizardsofm.deskclock.R.string.full_wday_month_day_no_year);
        ...
        if (view != null && view.findViewById(com.wizardsofm.deskclock.R.id.main_clock_left_pane) != null) {
    ...
    public void onUpdateFab(@NonNull ImageView fab) {
        ...
        fab.setImageResource(com.wizardsofm.deskclock.R.drawable.ic_language);
        fab.setContentDescription(fab.getResources().getString(com.wizardsofm.deskclock.R.string.button_cities));
    }
    ...
    private static final class SelectedCitiesAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                view = mInflater.inflate(com.wizardsofm.deskclock.R.layout.world_clock_item, parent, false);
            }

            // Configure the digital clock or analog clock depending on the user preference.
            final TextClock digitalClock = (TextClock) view.findViewById(com.wizardsofm.deskclock.R.id.digital_clock);
            final AnalogClock analogClock = (AnalogClock) view.findViewById(com.wizardsofm.deskclock.R.id.analog_clock);
            ...
            final int padding = res.getDimensionPixelSize(com.wizardsofm.deskclock.R.dimen.medium_space_top);
            ...
            final TextView dayOfWeek = (TextView) view.findViewById(com.wizardsofm.deskclock.R.id.city_day);
            ...
            if (displayDayOfWeek) {
                ...
                dayOfWeek.setText(mContext.getString(com.wizardsofm.deskclock.R.string.world_day_of_week_label, weekday));
            }
