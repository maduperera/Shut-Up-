...
public final class CollapsedAlarmViewHolder extends AlarmItemViewHolder {
    ...
    public static final int VIEW_TYPE = com.wizardsofm.deskclock.R.layout.alarm_time_collapsed;
    ...
    public CollapsedAlarmViewHolder(View itemView) {
        super(itemView);
        alarmLabel = (TextView) itemView.findViewById(com.wizardsofm.deskclock.R.id.label);
        daysOfWeek = (TextView) itemView.findViewById(com.wizardsofm.deskclock.R.id.days_of_week);
        upcomingInstanceLabel = (TextView) itemView.findViewById(com.wizardsofm.deskclock.R.id.upcoming_instance_label);
        hairLine = itemView.findViewById(com.wizardsofm.deskclock.R.id.hairline);
    ...
    private void bindReadOnlyLabel(Context context, Alarm alarm) {
        if (alarm.label != null && alarm.label.length() != 0) {
            ...
            alarmLabel.setContentDescription(context.getString(com.wizardsofm.deskclock.R.string.label_description)
                    + " " + alarm.label);
        } else {
    ...
    private void bindUpcomingInstance(Context context, Alarm alarm) {
        if (alarm.daysOfWeek.isRepeating()) {
            ...
            final String labelText = Alarm.isTomorrow(alarm, Calendar.getInstance()) ?
                    context.getString(com.wizardsofm.deskclock.R.string.alarm_tomorrow) :
                    context.getString(com.wizardsofm.deskclock.R.string.alarm_today);
