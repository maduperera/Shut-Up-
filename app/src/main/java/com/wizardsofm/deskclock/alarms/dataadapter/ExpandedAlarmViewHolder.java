...
import com.wizardsofm.deskclock.alarms.utils.DayOrderUtils;
...
public final class ExpandedAlarmViewHolder extends AlarmItemViewHolder {
    ...
    public static final int VIEW_TYPE = com.wizardsofm.deskclock.R.layout.alarm_time_expanded;
    ...
    public ExpandedAlarmViewHolder(View itemView, boolean hasVibrator) {
        ...
        for (int i = 0; i < DaysOfWeek.DAYS_IN_A_WEEK; i++) {
            final CompoundButton dayButton = (CompoundButton) mInflater.inflate(
                    com.wizardsofm.deskclock.R.layout.day_button, repeatDays, false /* attachToRoot */);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v.announceForAccessibility(context.getString(com.wizardsofm.deskclock.R.string.alarm_deleted));
            }
        });
    ...
    private void bindRingtone(Context context, Alarm alarm) {
        ...
        final String description = context.getString(com.wizardsofm.deskclock.R.string.ringtone_description);
        ringtone.setContentDescription(description + " " + title);

        final boolean silent = Utils.RINGTONE_SILENT.equals(alarm.alert);
        final int startResId = silent ? com.wizardsofm.deskclock.R.drawable.ic_ringtone_silent : com.wizardsofm.deskclock.R.drawable.ic_ringtone;
    ...
    private void bindEditLabel(Alarm alarm) {
        if (alarm.label != null && alarm.label.length() > 0) {
            ...
            editLabel.setText(com.wizardsofm.deskclock.R.string.label);
        }
    }
