...
import com.wizardsofm.deskclock.data.NotificationModel;
...
public final class AlarmNotifications {
    ...
    public static void showLowPriorityNotification(Context context, AlarmInstance instance) {
        ...
        NotificationCompat.Builder notification = new NotificationCompat.Builder(context)
                ...
                .setContentTitle(context.getString(
                        com.wizardsofm.deskclock.R.string.alarm_alert_predismiss_title))
                ...
                .setSmallIcon(com.wizardsofm.deskclock.R.drawable.stat_notify_alarm)
                .setAutoCancel(false)
    ...
    public static void showMissedNotification(Context context, AlarmInstance instance) {
        ...
        NotificationCompat.Builder notification = new NotificationCompat.Builder(context)
                .setShowWhen(false)
                .setContentTitle(context.getString(com.wizardsofm.deskclock.R.string.alarm_missed_title))
                .setContentText(instance.mLabel.isEmpty() ? alarmTime :
                        context.getString(com.wizardsofm.deskclock.R.string.alarm_missed_text, alarmTime, label))
                .setColor(ContextCompat.getColor(context, com.wizardsofm.deskclock.R.color.default_background))
                .setSortKey(createSortKey(instance))
                .setSmallIcon(com.wizardsofm.deskclock.R.drawable.stat_notify_alarm)
                .setPriority(NotificationCompat.PRIORITY_HIGH)
