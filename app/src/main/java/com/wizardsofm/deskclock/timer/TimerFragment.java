...
import com.wizardsofm.deskclock.data.TimerListener;
...
public final class TimerFragment extends DeskClockFragment {
        ...
        if (mCurrentView == mTimersView) {
            ...
            switch (timer.getState()) {
                case RUNNING:
                    ...
                    fab.setContentDescription(fab.getResources().getString(com.wizardsofm.deskclock.R.string.timer_stop));
                    break;
                case RESET:
                case PAUSED:
                    fab.setImageResource(com.wizardsofm.deskclock.R.drawable.ic_start_white_24dp);
                    fab.setContentDescription(fab.getResources().getString(com.wizardsofm.deskclock.R.string.timer_start));
                    break;
                case EXPIRED:
    ...
    public void onUpdateFabButtons(@NonNull ImageButton left, @NonNull ImageButton right) {
        if (mCurrentView == mTimersView) {
            ...
            left.setImageResource(com.wizardsofm.deskclock.R.drawable.ic_delete);
            left.setContentDescription(left.getResources().getString(com.wizardsofm.deskclock.R.string.timer_delete));
            left.setVisibility(mCurrentView != mTimersView ? GONE : VISIBLE);

            right.setEnabled(true);
            right.setImageResource(com.wizardsofm.deskclock.R.drawable.ic_add_timer);
            right.setContentDescription(right.getResources().getString(com.wizardsofm.deskclock.R.string.timer_add_timer));
            right.setVisibility(mCurrentView != mTimersView ? GONE : VISIBLE);

        } else if (mCurrentView == mCreateTimerView) {
            left.setEnabled(true);
            left.setImageResource(com.wizardsofm.deskclock.R.drawable.ic_close);
            left.setContentDescription(left.getResources().getString(com.wizardsofm.deskclock.R.string.timer_cancel));
        ...
        if (mCurrentView == mTimersView) {
            ...
            switch (timer.getState()) {
                case RUNNING:
                    ...
                    Events.sendTimerEvent(com.wizardsofm.deskclock.R.string.action_stop, com.wizardsofm.deskclock.R.string.label_deskclock);
                    break;
                case PAUSED:
                case RESET:
                    DataModel.getDataModel().startTimer(timer);
                    Events.sendTimerEvent(com.wizardsofm.deskclock.R.string.action_start, com.wizardsofm.deskclock.R.string.label_deskclock);
                    break;
                case EXPIRED:
            ...
            Events.sendTimerEvent(com.wizardsofm.deskclock.R.string.action_create, com.wizardsofm.deskclock.R.string.label_deskclock);
    ...
    public void onLeftButtonClick(@NonNull ImageButton left) {
        if (mCurrentView == mTimersView) {
            ...
            left.announceForAccessibility(getActivity().getString(com.wizardsofm.deskclock.R.string.timer_deleted));
            ...
            left.announceForAccessibility(getActivity().getString(com.wizardsofm.deskclock.R.string.timer_canceled));
        }
    }
    ...
    static int[] computePageIndicatorStates(int page, int pageIndicatorCount, int pageCount) {
        ...
        Arrays.fill(states, 0, rangeSize, com.wizardsofm.deskclock.R.drawable.ic_swipe_circle_dark);

        // If more pages exist before the first page indicator, make it a fade-in gradient.
        if (rangeStart > 0) {
            states[0] = com.wizardsofm.deskclock.R.drawable.ic_swipe_circle_top;
        }

        // If more pages exist after the last page indicator, make it a fade-out gradient.
        if (rangeEnd < pageCount - 1) {
            states[rangeSize - 1] = com.wizardsofm.deskclock.R.drawable.ic_swipe_circle_bottom;
        }

        // Set the indicator of the selected page to be light.
        states[page - rangeStart] = com.wizardsofm.deskclock.R.drawable.ic_swipe_circle_light;
    ...
    private void animateTimerRemove(final Timer timerToRemove) {
        ...
        fadeOut.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                Events.sendTimerEvent(com.wizardsofm.deskclock.R.string.action_delete, com.wizardsofm.deskclock.R.string.label_deskclock);
            }
        });
    ...
    private class TimerPageChangeListener extends ViewPager.SimpleOnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            updatePageIndicators();
            updateFab(UpdateType.FAB_AND_BUTTONS_IMMEDIATE);
