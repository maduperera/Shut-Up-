...
import com.wizardsofm.deskclock.FabContainer;
...
public class TimerSetupView extends LinearLayout implements Button.OnClickListener,
    ...
    public TimerSetupView(Context context, AttributeSet attrs) {
        ...
        mColorAccent = Utils.obtainStyledColor(context, com.wizardsofm.deskclock.R.attr.colorAccent, Color.RED);
        mColorHairline = ContextCompat.getColor(context, com.wizardsofm.deskclock.R.color.hairline);

        LayoutInflater.from(context).inflate(com.wizardsofm.deskclock.R.layout.time_setup_container, this);
    }
    ...
    protected void onFinishInflate() {
        ...
        final View v1 = findViewById(com.wizardsofm.deskclock.R.id.first);
        final View v2 = findViewById(com.wizardsofm.deskclock.R.id.second);
        final View v3 = findViewById(com.wizardsofm.deskclock.R.id.third);
        final View v4 = findViewById(com.wizardsofm.deskclock.R.id.fourth);

        mDivider = findViewById(com.wizardsofm.deskclock.R.id.divider);
        mDelete = (ImageButton) findViewById(com.wizardsofm.deskclock.R.id.delete);
        mDelete.setOnClickListener(this);
        mDelete.setOnLongClickListener(this);
        mEnteredTime = (TimerView) findViewById(com.wizardsofm.deskclock.R.id.timer_time_text);

        mNumbers[1] = (Button) v1.findViewById(com.wizardsofm.deskclock.R.id.key_left);
        mNumbers[2] = (Button) v1.findViewById(com.wizardsofm.deskclock.R.id.key_middle);
        mNumbers[3] = (Button) v1.findViewById(com.wizardsofm.deskclock.R.id.key_right);

        mNumbers[4] = (Button) v2.findViewById(com.wizardsofm.deskclock.R.id.key_left);
        mNumbers[5] = (Button) v2.findViewById(com.wizardsofm.deskclock.R.id.key_middle);
        mNumbers[6] = (Button) v2.findViewById(com.wizardsofm.deskclock.R.id.key_right);

        mNumbers[7] = (Button) v3.findViewById(com.wizardsofm.deskclock.R.id.key_left);
        mNumbers[8] = (Button) v3.findViewById(com.wizardsofm.deskclock.R.id.key_middle);
        mNumbers[9] = (Button) v3.findViewById(com.wizardsofm.deskclock.R.id.key_right);

        mNumbers[0] = (Button) v4.findViewById(com.wizardsofm.deskclock.R.id.key_middle);
        v4.findViewById(com.wizardsofm.deskclock.R.id.key_left).setVisibility(INVISIBLE);
        v4.findViewById(com.wizardsofm.deskclock.R.id.key_right).setVisibility(INVISIBLE);
        ...
        for (int i = 0; i < mNumbers.length; i++) {
            ...
            mNumbers[i].setTag(com.wizardsofm.deskclock.R.id.numbers_key, i);
        }
    ...
    public void onClick(View v) {
        ...
        final Integer n = (Integer) v.getTag(com.wizardsofm.deskclock.R.id.numbers_key);
        ...
        if (n != null) {
            ...
            final String cd = resources.getString(com.wizardsofm.deskclock.R.string.timer_descriptive_delete, n.toString());
        ...
        if (v == mDelete) {
            ...
            final String cd = getResources().getString(com.wizardsofm.deskclock.R.string.timer_descriptive_delete, number);
            mDelete.setContentDescription(cd);
        }
    ...
    private void updateFab() {
        mFabContainer.updateFab(FabContainer.UpdateType.FAB_ONLY_SHRINK_AND_EXPAND);
    }
}
