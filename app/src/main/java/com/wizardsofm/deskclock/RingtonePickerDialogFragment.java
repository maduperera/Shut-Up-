...
public final class RingtonePickerDialogFragment extends DialogFragment implements
    ...
    public AlertDialog onCreateDialog(Bundle savedInstanceState) {
        final AlertDialog.Builder builder =
                new AlertDialog.Builder(getActivity(), com.wizardsofm.deskclock.R.style.DialogTheme);
        final Bundle args = getArguments();

        mRingtoneAdapter = new RingtoneAdapter(builder.getContext())
                .addStaticRingtone(com.wizardsofm.deskclock.R.string.silent_ringtone_title, Utils.RINGTONE_SILENT)
    ...
    private static class RingtoneAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            if (view == null) {
                ...
                view = mLayoutInflater.inflate(com.wizardsofm.deskclock.R.layout.select_dialog_singlechoice_material,
