...
package com.wizardsofm.deskclock.events;
...
public final class Events {
    ...
    public static void sendAlarmEvent(@StringRes int action, @StringRes int label) {
        sendEvent(com.wizardsofm.deskclock.R.string.category_alarm, action, label);
    }
    ...
    public static void sendClockEvent(@StringRes int action, @StringRes int label) {
        sendEvent(com.wizardsofm.deskclock.R.string.category_clock, action, label);
    }
    ...
    public static void sendTimerEvent(@StringRes int action, @StringRes int label) {
        sendEvent(com.wizardsofm.deskclock.R.string.category_timer, action, label);
    }
    ...
    public static void sendStopwatchEvent(@StringRes int action, @StringRes int label) {
        sendEvent(com.wizardsofm.deskclock.R.string.category_stopwatch, action, label);
    }
