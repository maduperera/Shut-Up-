...
import com.wizardsofm.deskclock.provider.DaysOfWeek;
import com.wizardsofm.deskclock.timer.TimerFragment;
...
public class HandleApiCalls extends Activity {
    ...
    public static void dismissAlarm(Alarm alarm, Context context, Activity activity) {
        ...
        if (alarmInstance == null) {
            final String reason = context.getString(com.wizardsofm.deskclock.R.string.no_alarm_scheduled_for_this_time);
        ...
        if (Utils.isAlarmWithin24Hours(alarmInstance)) {
            ...
            final String reason = context.getString(com.wizardsofm.deskclock.R.string.alarm_is_dismissed, time);
            LogUtils.i(reason);
            ...
            final String reason = context.getString(
                    com.wizardsofm.deskclock.R.string.alarm_cant_be_dismissed_still_more_than_24_hours_away, time);
            Voice.notifyFailure(activity, reason);
            LogUtils.i(reason);
        }
    }
    ...
    private static class DismissAlarmAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... parameters) {
            ...
            if (alarms.isEmpty()) {
                final String reason = mContext.getString(com.wizardsofm.deskclock.R.string.no_scheduled_alarms);
                LogUtils.i(reason);
            ...
            if (searchMode == null && alarms.size() > 1) {
                ...
                Voice.notifySuccess(mActivity, mContext.getString(com.wizardsofm.deskclock.R.string.pick_alarm_to_dismiss));
                return null;
            }
    ...
    private static class SnoozeAlarmAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... parameters) {
            ...
            if (alarmInstances.isEmpty()) {
                final String reason = mContext.getString(com.wizardsofm.deskclock.R.string.no_firing_alarms);
                LogUtils.i(reason);
                Voice.notifyFailure(mActivity, reason);
                return null;
            }
    ...
    static void snoozeAlarm(AlarmInstance alarmInstance, Context context, Activity activity) {
        ...
        final String time = DateFormat.getTimeFormat(context).format(
                alarmInstance.getAlarmTime().getTime());
        final String reason = context.getString(com.wizardsofm.deskclock.R.string.alarm_is_snoozed, time);
        LogUtils.i(reason);
        Voice.notifySuccess(activity, reason);
    ...
    private void handleSetAlarm(Intent intent) {
        ...
        if (hour < 0 || hour > 23 || minutes < 0 || minutes > 59) {
            ...
            Voice.notifyFailure(this, getString(com.wizardsofm.deskclock.R.string.invalid_time, hour, minutes, " "));
            LogUtils.i("HandleApiCalls no/invalid time; opening UI");
            return;
        }

        Events.sendAlarmEvent(com.wizardsofm.deskclock.R.string.action_create, com.wizardsofm.deskclock.R.string.label_intent);
        ...
        final String time = DateFormat.getTimeFormat(mAppContext).format(
                alarmInstance.getAlarmTime().getTime());
        Voice.notifySuccess(this, getString(com.wizardsofm.deskclock.R.string.alarm_is_set, time));
    ...
    private void handleShowAlarms() {
        ...
        Events.sendAlarmEvent(com.wizardsofm.deskclock.R.string.action_show, com.wizardsofm.deskclock.R.string.label_intent);
    ...
    private void handleSetTimer(Intent intent) {
        ...
        if (lengthMillis < Timer.MIN_LENGTH || lengthMillis > Timer.MAX_LENGTH) {
            Voice.notifyFailure(this, getString(com.wizardsofm.deskclock.R.string.invalid_timer_length));
        ...
        if (timer == null) {
            ...
            Events.sendTimerEvent(com.wizardsofm.deskclock.R.string.action_create, com.wizardsofm.deskclock.R.string.label_intent);
        }

        // Start the selected timer.
        DataModel.getDataModel().startTimer(timer);
        Events.sendTimerEvent(com.wizardsofm.deskclock.R.string.action_start, com.wizardsofm.deskclock.R.string.label_intent);
        Voice.notifySuccess(this, getString(com.wizardsofm.deskclock.R.string.timer_created));
