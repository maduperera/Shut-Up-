...
final class AlarmModel {
    ...
    String getAlarmRingtoneTitle(Uri uri) {
        ...
        if (Alarm.NO_RINGTONE_URI.equals(uri)) {
            return mContext.getString(com.wizardsofm.deskclock.R.string.silent_ringtone_title);
        }
        ...
        if (title == null) {
            ...
            if (ringtone == null) {
                ...
                return mContext.getString(com.wizardsofm.deskclock.R.string.unknown_ringtone_title);
            }
