...
import com.wizardsofm.deskclock.stopwatch.StopwatchService;
...
class StopwatchNotificationBuilderN implements StopwatchModel.NotificationBuilder {
    ...
    public Notification build(Context context, NotificationModel nm, Stopwatch stopwatch) {
        @StringRes final int eventLabel = com.wizardsofm.deskclock.R.string.label_notification;
        ...
        final RemoteViews content = new RemoteViews(pname, com.wizardsofm.deskclock.R.layout.chronometer_notif_content);
        ...
        if (running) {
            ...
            if (DataModel.getDataModel().canAddMoreLaps()) {
                ...
                final Icon icon2 = Icon.createWithResource(context, com.wizardsofm.deskclock.R.drawable.ic_sw_lap_24dp);
            ...
            if (lapCount > 0) {
                ...
                final String lap = res.getString(com.wizardsofm.deskclock.R.string.sw_notification_lap_number, lapNumber);
            ...
            content.setTextViewText(com.wizardsofm.deskclock.R.id.state, res.getString(com.wizardsofm.deskclock.R.string.swn_paused));
            content.setViewVisibility(com.wizardsofm.deskclock.R.id.state, VISIBLE);
        }
