        ...
        switch (searchMode) {
            case AlarmClock.ALARM_SEARCH_MODE_TIME:
                ...
                if (badInput) {
                    ...
                    final String reason = mContext.getString(com.wizardsofm.deskclock.R.string.invalid_time, hour, minutes,
                            amPm);
                ...
                if (mMatchingAlarms.isEmpty()) {
                    final String reason = mContext.getString(com.wizardsofm.deskclock.R.string.no_alarm_at, hour24, minutes);
                    notifyFailureAndLog(reason, mActivity);
                    return;
                }
                break;
            ...
            case AlarmClock.ALARM_SEARCH_MODE_LABEL:
                ...
                if (label == null) {
                    final String reason = mContext.getString(com.wizardsofm.deskclock.R.string.no_label_specified);
                    notifyFailureAndLog(reason, mActivity);
                    return;
                }
                ...
                if (mMatchingAlarms.isEmpty()) {
                    final String reason = mContext.getString(com.wizardsofm.deskclock.R.string.no_alarms_with_label);
                    notifyFailureAndLog(reason, mActivity);
                    return;
                }
                break;
