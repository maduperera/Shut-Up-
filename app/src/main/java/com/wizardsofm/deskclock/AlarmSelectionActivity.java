...
import com.wizardsofm.deskclock.widget.selector.AlarmSelection;
import com.wizardsofm.deskclock.widget.selector.AlarmSelectionAdapter;
...
public class AlarmSelectionActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.wizardsofm.deskclock.R.layout.selection_layout);

        final Button cancelButton = (Button) findViewById(com.wizardsofm.deskclock.R.id.cancel_button);
        ...
        setListAdapter(new AlarmSelectionAdapter(this, com.wizardsofm.deskclock.R.layout.alarm_row, mSelections));
    }
