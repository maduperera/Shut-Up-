...
import com.wizardsofm.deskclock.RingtonePickerDialogFragment;
...
public final class SettingsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.wizardsofm.deskclock.R.layout.settings);
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction()
                    .replace(com.wizardsofm.deskclock.R.id.main, new PrefsFragment(), PREFS_FRAGMENT_TAG)
    ...
    protected void onResume() {
        ...
        final PrefsFragment fragment =
                (PrefsFragment) getFragmentManager().findFragmentById(com.wizardsofm.deskclock.R.id.main);
    ...
    public static class PrefsFragment extends PreferenceFragment implements
        ...
        public void onCreatePreferences(Bundle bundle, String rootKey) {
            ...
            addPreferencesFromResource(com.wizardsofm.deskclock.R.xml.settings);
            loadTimeZoneList();
        }
            ...
            switch (pref.getKey()) {
                ...
                case KEY_TIMER_RINGTONE:
                    new RingtonePickerDialogFragment.Builder()
                            .setTitle(com.wizardsofm.deskclock.R.string.timer_ringtone_title)
                            .setDefaultRingtoneTitle(com.wizardsofm.deskclock.R.string.default_timer_ringtone_title)
        ...
        public CharSequence[][] getAllTimezones() {
            ...
            final String[] ids = res.getStringArray(com.wizardsofm.deskclock.R.array.timezone_values);
            final String[] labels = res.getStringArray(com.wizardsofm.deskclock.R.array.timezone_labels);
        ...
        private void updateAutoSnoozeSummary(ListPreference listPref, String delay) {
            ...
            if (i == -1) {
                listPref.setSummary(com.wizardsofm.deskclock.R.string.auto_silence_never);
            } else {
                listPref.setSummary(Utils.getNumberFormattedQuantityString(getActivity(),
                        com.wizardsofm.deskclock.R.plurals.auto_silence_summary, i));
            }
        }
