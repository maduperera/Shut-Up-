...
import com.wizardsofm.deskclock.NumberPickerCompat;
...
public class SnoozeLengthDialogFragment extends PreferenceDialogFragment {
    ...
    protected void onBindDialogView(View view) {
        ...
        final CharSequence units =
                getResources().getQuantityText(com.wizardsofm.deskclock.R.plurals.snooze_picker_label, snoozeMinutes);
        final TextView unitView = (TextView) view.findViewById(com.wizardsofm.deskclock.R.id.title);
        unitView.setText(units);

        mNumberPickerView = (NumberPickerCompat) view.findViewById(com.wizardsofm.deskclock.R.id.minutes_picker);
                ...
                new NumberPickerCompat.OnAnnounceValueChangedListener() {
                    ...
                    public void onAnnounceValueChanged(NumberPicker picker, int value,
                        ...
                        final String announceString = Utils.getNumberFormattedQuantityString(
                                getActivity(), com.wizardsofm.deskclock.R.plurals.snooze_duration, value);
