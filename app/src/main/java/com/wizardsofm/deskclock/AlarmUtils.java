...
public class AlarmUtils {
    ...
    static String formatElapsedTimeUntilAlarm(Context context, long delta) {
        ...
        final String[] formats = context.getResources().getStringArray(com.wizardsofm.deskclock.R.array.alarm_set);
        ...
        String daySeq = Utils.getNumberFormattedQuantityString(context, com.wizardsofm.deskclock.R.plurals.days, days);
