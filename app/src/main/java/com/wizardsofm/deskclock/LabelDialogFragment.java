...
public class LabelDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final int padding = getResources().getDimensionPixelSize(com.wizardsofm.deskclock.R.dimen.label_edittext_padding);
        final AlertDialog alertDialog = new AlertDialog.Builder(context)
                .setView(mLabelBox, padding, 0, padding, 0)
                .setPositiveButton(com.wizardsofm.deskclock.R.string.time_picker_set, new OkListener())
                .setNegativeButton(com.wizardsofm.deskclock.R.string.time_picker_cancel, new CancelListener())
                .setMessage(com.wizardsofm.deskclock.R.string.label)
                .create();
    ...
    private class TextChangeListener implements TextWatcher {
        ...
        public TextChangeListener(Context context) {
            colorAccent = Utils.obtainStyledColor(context, com.wizardsofm.deskclock.R.attr.colorAccent, RED);
            colorControlNormal = Utils.obtainStyledColor(context, com.wizardsofm.deskclock.R.attr.colorControlNormal, WHITE);
        }
