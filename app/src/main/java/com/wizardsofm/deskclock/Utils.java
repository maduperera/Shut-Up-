    ...
    */
    ...
    public static float calculateRadiusOffset(Resources resources) {
        if (resources != null) {
            ...
            float markerStrokeSize = resources.getDimension(com.wizardsofm.deskclock.R.dimen.circletimer_marker_size);
    ...
    public static void refreshAlarm(Context context, View clock) {
        final TextView nextAlarmIconView = (TextView) clock.findViewById(com.wizardsofm.deskclock.R.id.nextAlarmIcon);
        final TextView nextAlarmView = (TextView) clock.findViewById(com.wizardsofm.deskclock.R.id.nextAlarm);
        ...
        if (!TextUtils.isEmpty(alarm)) {
            final String description = context.getString(com.wizardsofm.deskclock.R.string.next_alarm_description, alarm);
