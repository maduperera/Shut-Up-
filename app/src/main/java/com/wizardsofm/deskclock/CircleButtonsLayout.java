...
public class CircleButtonsLayout extends FrameLayout {
    ...
    public CircleButtonsLayout(Context context, AttributeSet attrs) {
        ...
        final float strokeSize = res.getDimension(com.wizardsofm.deskclock.R.dimen.circletimer_circle_size);
        final float dotStrokeSize = res.getDimension(com.wizardsofm.deskclock.R.dimen.circletimer_dot_size);
        final float markerStrokeSize = res.getDimension(com.wizardsofm.deskclock.R.dimen.circletimer_marker_size);
    ...
    protected void remeasureViews() {
        if (mLabel == null) {
            mCircleView = findViewById(com.wizardsofm.deskclock.R.id.timer_time);
            mLabel = (TextView) findViewById(com.wizardsofm.deskclock.R.id.timer_label);
            mResetAddButton = (ImageButton) findViewById(com.wizardsofm.deskclock.R.id.reset_add);
        }
