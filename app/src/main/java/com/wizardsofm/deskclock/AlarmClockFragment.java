...
import com.wizardsofm.deskclock.alarms.AlarmTimeClickHandler;
import com.wizardsofm.deskclock.alarms.AlarmUpdateHandler;
import com.wizardsofm.deskclock.alarms.ScrollHandler;
import com.wizardsofm.deskclock.alarms.TimePickerCompat;
import com.wizardsofm.deskclock.alarms.dataadapter.AlarmItemHolder;
import com.wizardsofm.deskclock.alarms.dataadapter.CollapsedAlarmViewHolder;
import com.wizardsofm.deskclock.alarms.dataadapter.ExpandedAlarmViewHolder;
...
import com.wizardsofm.deskclock.widget.EmptyViewController;
import com.wizardsofm.deskclock.widget.toast.SnackbarManager;
import com.wizardsofm.deskclock.widget.toast.ToastManager;
...
public final class AlarmClockFragment extends DeskClockFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
        ...
        final View v = inflater.inflate(com.wizardsofm.deskclock.R.layout.alarm_clock, container, false);
        final Context context = getActivity();

        mRecyclerView = (RecyclerView) v.findViewById(com.wizardsofm.deskclock.R.id.alarms_recycler_view);
        mLayoutManager = new LinearLayoutManager(context);
        mRecyclerView.setLayoutManager(mLayoutManager);
        mMainLayout = (ViewGroup) v.findViewById(com.wizardsofm.deskclock.R.id.main);
        mAlarmUpdateHandler = new AlarmUpdateHandler(context, this, mMainLayout);
        final TextView emptyView = (TextView) v.findViewById(com.wizardsofm.deskclock.R.id.alarms_empty_view);
        final Drawable noAlarms = Utils.getVectorDrawable(context, com.wizardsofm.deskclock.R.drawable.ic_noalarms);
    ...
    private void scrollToAlarm(long alarmId) {
        ...
        if (alarmPosition >= 0) {
            ...
            SnackbarManager.show(Snackbar.make(mMainLayout, com.wizardsofm.deskclock.R.string
    ...
    public void onUpdateFab(@NonNull ImageView fab) {
        ...
        fab.setImageResource(com.wizardsofm.deskclock.R.drawable.ic_add_white_24dp);
        fab.setContentDescription(fab.getResources().getString(com.wizardsofm.deskclock.R.string.button_alarms));
    }
