 ...
 * according to its layout constraints up to the {@link com.wizardsofm.deskclock.R.dimen#max_timer_circle_size largest}
 * allowable size.
 */
public class TimerCircleFrameLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int maxSize = getResources().getDimensionPixelSize(com.wizardsofm.deskclock.R.dimen.max_timer_circle_size);
