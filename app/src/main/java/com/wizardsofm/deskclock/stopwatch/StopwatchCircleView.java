...
public final class StopwatchCircleView extends View {
    ...
    public StopwatchCircleView(Context context, AttributeSet attrs) {
        ...
        final float dotDiameter = resources.getDimension(com.wizardsofm.deskclock.R.dimen.circletimer_dot_size);

        mDotRadius = dotDiameter / 2f;
        mScreenDensity = resources.getDisplayMetrics().density;
        mStrokeSize = resources.getDimension(com.wizardsofm.deskclock.R.dimen.circletimer_circle_size);
        mMarkerStrokeSize = resources.getDimension(com.wizardsofm.deskclock.R.dimen.circletimer_marker_size);
        mRadiusOffset = Utils.calculateRadiusOffset(mStrokeSize, dotDiameter, mMarkerStrokeSize);

        mRemainderColor = Color.WHITE;
        mCompletedColor = Utils.obtainStyledColor(context, com.wizardsofm.deskclock.R.attr.colorAccent, Color.RED);
