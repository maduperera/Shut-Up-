...
public class ScreensaverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.wizardsofm.deskclock.R.layout.desk_clock_saver);
        mDigitalClock = findViewById(com.wizardsofm.deskclock.R.id.digital_clock);
        mAnalogClock = findViewById(com.wizardsofm.deskclock.R.id.analog_clock);
        mSaverView = findViewById(com.wizardsofm.deskclock.R.id.main_clock);
        mContentView = findViewById(com.wizardsofm.deskclock.R.id.saver_container);
