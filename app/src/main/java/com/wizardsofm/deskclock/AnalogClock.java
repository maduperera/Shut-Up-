...
public class AnalogClock extends View {
    ...
    public AnalogClock(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDial = initDrawable(context, com.wizardsofm.deskclock.R.drawable.clock_analog_dial);
        mHourHand = initDrawable(context, com.wizardsofm.deskclock.R.drawable.clock_analog_hour);
        mMinuteHand = initDrawable(context, com.wizardsofm.deskclock.R.drawable.clock_analog_minute);
        mSecondHand = initDrawable(context, com.wizardsofm.deskclock.R.drawable.clock_analog_second);
    }
