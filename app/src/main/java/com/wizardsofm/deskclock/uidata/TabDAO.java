...
package com.wizardsofm.deskclock.uidata;
...
final class TabDAO {
     ...
     */
    static UiDataModel.Tab getSelectedTab(Context context) {
        final SharedPreferences prefs = getSharedPreferences(context);
        final int selectedTabOrdinal = prefs.getInt(KEY_SELECTED_TAB, UiDataModel.Tab.CLOCKS.ordinal());
        return UiDataModel.Tab.values()[selectedTabOrdinal];
    }

    /**
     * @param tab an enumerated value indicating the newly selected primary tab
     */
    static void setSelectedTab(Context context, UiDataModel.Tab tab) {
